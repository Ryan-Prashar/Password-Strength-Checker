...
def check_password_strength():
   ...
   # This shows the password what you type
#  password = input('Enter the password: ') 

#  This hides the password that you type
...
#  Counts the number of each character type in the password typed by us
...
# Calculates the Strength of our Password
   if strength == 1:
...
#  Prints the number of each type of Characters
